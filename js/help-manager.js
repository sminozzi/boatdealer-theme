jQuery(document).ready(function($){
  ...
  $('#boatdealer_update_theme3').click(function(evn){
   ...
   if($('#boatdealer_update_theme3').is(':checked'))
    { cval = '1';    }
   else
    { cval = '0';    }
   ...
   $('#boatdealer-update-theme2').submit();

  });   
    
     $( "#boatdealer-open-help" ).click(function() {
   ...
   $( "#boatdealer-send-support" ).click(function(evt) {
       // cliccou no support
       
       // alert(evt.target.id);
       
       
       $modalvma = $('.bill-support-boatdealer')
       var activated = $('#activated').val();
       
       if(activated !== '1')
       {
                        $("#boatdealer-not-activated").dialog({
                            modal: true,
                            ...
                            buttons: {
                                Ok: function () {
                                    $(this).dialog("close");
                                    location.reload();
                                    /* $("#boatdealer-not-activated").remove(); */
                                }
                            }
                        }); //end confirm dialog      
  ...
  $( ".button-close-spsubmit" ).click(function() {
       // submeteu support
                    // var isAnonymousFeedback = $(".anonymous").prop("checked");
                     ...
                     $('#boatdealer-imagewait3').css('visibility','visible');
                     ...
                     $.ajax({
                		...
                		complete  : function () {
                             ...
                             // $modalvma = $('.bill-feedback-boatdealer')
                              $('#boatdealer-imagewait2').css('visibility','hidden');
                              $modalvma.slideUp();
   ...
   /*  Feedback ------ */
   $( "#boatdealer-give-feedback" ).click(function(evt) {
       // cliccou no feedback
       
       $modalvmaf = $('.bill-feedback-boatdealer');
  ...
  $( ".button-close-fbsubmit" ).click(function() {
       // submeteu feedback
                    ...
                    if(isAnonymousFeedback)
                    {
                     ...
                     $('#boatdealer-imagewait2').css('visibility','visible');
  ...
  $("#boatdealer-btn-connect-now" ).click(function(evt) {
                     ...
                     $('#boatdealer-imagewait').css('visibility','visible');
                     $( "#boatdealer-btn-connect-now" ).addClass('disabled');
                     $.ajax({
                	    url       : 'http://billminozzi.com/httpapi/httpapi.php',
                        withCredentials: true,
                        timeout: 15000,
                		...
                		complete  : function () {
                             ...
                             cvalue = "1-"+dom;
                             document.cookie = "bill_activated_vm" + "=" + cvalue + ";" + expires + ";path=/";
                             $('#boatdealer-imagewait').css('visibility','hidden');
  ...
  $( ".button-close-faqsubmit" ).click(function() {
       // submeteu faq
                     ...
                     $('#boatdealer-imagewait20').css('visibility','hidden');
                    ...
                    if(isAnonymousFeedback)
                    {
                     ...
                     $('#boatdealer-imagewait20').css('visibility','visible');
