 ...
 */
   if(memory_status()) 
    { 
?>
      <div id="boatdealer-status-box">
        <div class="boatdealer-block-title">
          Optional
      </div>   
      <div id="boatdealer-help-status">
      <?php
        if($activated == '1' )
        {
           echo '<img alt="aux" id="connect_status" src="'.get_template_directory_uri().'/images/pluggedx64.png" />';
           echo '<div class= "boatdealer_status_row"> Opt-in: <font color="green">OK</font></div>';
           echo '</div>';
            ?> 
            <div id="boatdealer-connect-tip">
            Thank you for help us improve our theme. 
            You will get access to one <strong>free</strong> box, in this page, 
            to send messages to our support for 30 days (look for Open Support Form Button) and get <strong>automatic</strong> updates for Boat Dealer Theme for free.
          </div> 
          <div id="boatdealer-update-theme">
            <form id="boatdealer-update-theme2" action="<?php get_theme_file_uri()?>/wp-admin/themes.php?page=boat_dealer" method="post" target="_self" >
                <?php      
                if($boatdealer_update_theme == '1')
                 $checked = 'checked';
                else
                  $checked = '';
                echo '<input id="boatdealer_update_theme3" name="boatdealer_update_theme" type="checkbox" '.$checked. ' value="yes" />  Check to enable theme automatic update.';
                ?>
            </form>
          </div>       
          <?php
        ...
        else
        {
             ...
             echo '<div class= "boatdealer_status_row"> Opt-in: <font color="red">Not Yet!</font></div>';
             echo '<a href="#" id="boatdealer-btn-connect-now" class="button button-primary">Opt-in Now</a>';
             echo '<img alt="aux" src="/wp-admin/images/wpspin_light-2x.gif" id="boatdealer-imagewait" style="visibility:hidden" />';
             echo '</div>';
          ?>
          <div id="boatdealer-connect-tip">
            ...
            will be sent to us).
            You will get access to one <strong>free</strong> box, in this page, 
            to send messages to our support for 30 days and get <strong>automatic</strong> updates for Boat Dealer Theme for free.
          </div> 
		    ...
		    <input type="hidden" id="produto2" name="produto" value="boatdealer" />
   ...
   <?php } // end connect div ?>
   <div id="boatdealer-steps3">
       <div class="boatdealer-block-title"> 
           <img alt="aux" src="<?php echo get_template_directory_uri()?>/images/3steps.png" />
           <br />   <br />
           Follow this 3 steps after install the theme:
       </div>
    <div class="boatdealer-help-container1">
        <div class="boatdealer-help-column boatdealer-help-column-1">
        ...
        <div class="boatdealer-help-column boatdealer-help-column-2">
       ...
       <div class="boatdealer-help-column boatdealer-help-column-3">
   ...
   </div> <!-- "boatdealer-steps3"> -->
   <div id="boatdealer-services3">
     <div class="boatdealer-block-title">
    ...
    <div class="boatdealer-help-container1">
        <div class="boatdealer-help-column boatdealer-help-column-1">
          ...
          <?php 
          if( memory_status())
            echo '<a href="#" id="boatdealer-open-help" class="button button-primary">Open Help</a>';
          else
          ...
          <?php 
          if( memory_status())
            echo '<a href="#" id="boatdealer-send-support" class="button button-primary">Open Support Form</a>';
          else
        ...
        <div class="boatdealer-help-column boatdealer-help-column-2">
          ...
          <br /><br />
          <?php $site = 'http://boatdealerthemes.com'; ?>
