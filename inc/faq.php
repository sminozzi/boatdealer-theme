 ...
 */
 ...
 if(! memory_status())
 {
    echo '<h3>Boat Dealer Theme Running in Save Memory Mode.</h3>';
    return;
  }   
      
?>
    <div id="boatdealer-faq-page">
        <div class="boatdealer-block-title"> 
               Faq Page
        </div>
    <div class="bill-faq-boatdealer-wrap" style="">
     <div class="bill-faq-boatdealer" style="">
     ...
     <br /><br />
     <textarea rows="6" id="explanationfaq" name="explanation" placeholder="<?php _e("type here your question ...","boatdealer");?>" style="width:100%;" ></textarea>
                 <?php
                 if($activated != '1' )
                 {
  ?>
           ...
           <?php } ?>  
                 <br /><br /> 			
		    			<a href="#" class="button button-primary button-close-faqsubmit"><?php _e("Submit","boatdealer");?></a>
                        <img alt="aux" src="/wp-admin/images/wpspin_light-2x.gif" id="boatdealer-imagewait20" style="visibility:hidden" />
